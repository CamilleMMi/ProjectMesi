...
<html lang="en">
  <head>
    ...
    <link href="/ui/admin/admin.css" rel="stylesheet" type="text/css">
...
<body>
  <style>
    ...
    <thead>
        ...
        <th data-field="_id" data-filter-control="input" data-sortable="true">ID</th>
        <th data-field="email" data-filter-control="input">Email</th>
        <th data-field="nom" data-filter-control="input" data-formatter="formatterName">Nom Prénom</th>
        <th data-field="pseudo" data-filter-control="input">Pseudonyme</th>
        <th data-field="date_naissance" data-filter-control="input">Date de naissance</th>
        <th data-field="description" data-filter-control="input">Description</th>
        <th data-field="link" data-filter-control="input">Lien externe</th>
...
function formatterUser(value, row, index, field) {
  //href="/admin/${row._id}/info"
    const buttons = `<a href="#" class="btn btnEdit btn-info"><i class="bi bi-search"></i></a>
                     <a href="#" class="btn btnEdit btn-warning"><i class="bi bi-pencil-square"></i></a>`;
